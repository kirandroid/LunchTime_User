 ...
 * This class houses all the API service methods that implements the response listener, api type, and request
 * This helps in reducing boilerplate codes on API calls
 */
